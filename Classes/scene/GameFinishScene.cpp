...
cocos2d::Scene* GameFinishLayer::createScene(PlayerScoreInfo playerScore) {
...
GameFinishLayer* GameFinishLayer::create(PlayerScoreInfo playerScore) {
...
bool GameFinishLayer::init(PlayerScoreInfo playerScore) {
